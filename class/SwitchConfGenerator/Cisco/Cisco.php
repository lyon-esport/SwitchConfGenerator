...
use Project\SwitchConfGenerator\Switchs;

class Cisco extends Switchs
{
    public $acl;
    ...
    {
        parent::__construct($hostname, $default_gateway, $bannerMotd, $spanningTree, $snmp, $authorization, $vlans);
        $this->acl = $acl;
    }
}