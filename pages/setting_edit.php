...
//ID of template or create a new one
$setting = array();
...
if(!isset($_GET['new']))
{
    ...
    try
    {
        ...
        $setting["vlan_setting"] = $BDD->get_port_config($id);
        $setting["vlan"] = $BDD->get_vlans($id);
    }
    catch(Exception $e)
    {
        create_message([['title' => 'Error !', 'content' => 'An error occurred when processing your request', 'color' => 'error', 'delete' => true, 'container' => true]]);
...
echo $twig->render('page_setting_edit.twig', array(
    'index_path' => '../',
    'pages_path' => '',
    'images_path' => '../',
    'css_path' => '../',
